            ...
            .then(() => deployer.deploy(PoolTogetherAdapter, { from: accounts[0] })
              .then(() => deployer.deploy(SynthetixAdapter, { from: accounts[0] })
                .then(() => deployer.deploy(ZrxAdapter, { from: accounts[0] })
                  .then(() => AdapterRegistry.at('0xAdapterRegistryAddress')
                    .then((registry) => {
                      adapterRegistry = registry;
                      return adapterRegistry.methods['addAdapter(address,address[])'](AaveAdapter.address, aaveAdapterAssets, { from: accounts[0] });
                    })
                    .then(() => adapterRegistry.methods['addAdapter(address,address[])'](CompoundAdapter.address, compoundAdapterAssets, { from: accounts[0] }))
                    .then(() => adapterRegistry.methods['addAdapter(address,address[])'](CurveAdapter.address, curveAdapterAssets, { from: accounts[0] }))
                    .then(() => adapterRegistry.methods['addAdapter(address,address[])'](DSRAdapter.address, dsrAdapterAssets, { from: accounts[0] }))
                    .then(() => adapterRegistry.methods['addAdapter(address,address[])'](MCDAdapter.address, mcdAdapterAssets, { from: accounts[0] }))
                    .then(() => adapterRegistry.methods['addAdapter(address,address[])'](PoolTogetherAdapter.address, poolTogetherAdapterAssets, { from: accounts[0] }))
                    .then(() => adapterRegistry.methods['addAdapter(address,address[])'](SynthetixAdapter.address, synthetixAdapterAssets, { from: accounts[0] }))
                    .then(() => adapterRegistry.methods['addAdapter(address,address[])'](ZrxAdapter.address, zrxAdapterAssets, { from: accounts[0] }))))))))));
};
